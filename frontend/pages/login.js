...
const Login = () => {
    ...
    const UserLogin = (e) => {
        ...
        fetch("http://localhost:8081/users/login", reqOptions)
            ...
            .then((response) => {
                if (response.error) {
                    ...
                    console.log("your data is : ", response.data.token.token)
    ...
    return (
        ...
        <>
            ...
            <div class="flex justify-center my-2 mx-4 md:mx-0">
                <form onSubmit={UserLogin} class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-full px-3 mb-6">
                            ...
                            <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='email' name="email" value={values.email} onChange={handleInputChange} required/>
                        </div>
                        <div class="w-full md:w-full px-3 mb-6">
                            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for='Password'>Password</label>
                            <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" value={values.password} onChange={handleInputChange} type='password' name="password" required/>
                        </div>
                        ...
                        <div class="w-full md:w-full px-3 mb-6">
                            <input type='submit' value="Sign In" class="appearance-none block w-full bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500"/>
                        </div>
